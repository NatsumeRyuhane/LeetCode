...
- **Source:** https://leetcode.cn/problems/smallest-missing-integer-greater-than-sequential-prefix-sum/
- **Difficulty:** Easy
...
`nums[j] = nums[j - 1] + 1`. In particular, the prefix consisting only of `nums[0]`
is sequential.
...
12, 13, and 14 belong to the array while 15 does not. Therefore 15 is the smallest
